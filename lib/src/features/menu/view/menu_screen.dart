...
class _MenuScreenState extends State<MenuScreen> {
  ...
  void _menuScrollListener() {
    ...
    if (_menuController.position.userScrollDirection == ScrollDirection.reverse && 
    ...
    } else if (_menuController.position.userScrollDirection == ScrollDirection.forward && 
    _menuController.offset < _sumCategoryHeight - _getActiveCategoryItemHeight()) {
